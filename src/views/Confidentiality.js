      ...
      <div className='content'>
        <div className='policy'>
          <div className='welcomeHD'>
            ...
            сервисами Сайта <a href='https://humdesign.ru'>https://humdesign.ru</a></p>
          ...
          <div className='policy__art'>
            ...
            <p>2.2. Обработка указанных выше персональных данных осуществляется Оператором исключительно в целях заключения и исполнения&nbsp;гражданско-правовых договоров; предоставления&nbsp;доступа Пользователю к сервисам, информации и/или материалам, содержащимся на cайте:&nbsp;<a href="https://humdesign.ru">https://humdesign.ru</a>&nbsp;и для уточнения&nbsp;деталей заказа.&nbsp;&nbsp;Персональные данные Оператором не распространяются и не передаются третьим лицам.</p>
